$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-label"] = new basedisplay("default-label", "", "default", {'static_css': {'title2_style': 'color: #fff;', 'value_style': 'color: #fff;', 'unit_style': '', 'title_style': 'color: #fff;', 'widget_style': 'background-color: #444;', 'state_text_style': 'color: #fff;'}, 'css': {}, 'widget_type': 'basedisplay', 'static_icons': [], 'fields': {'title2': '', 'state_text': '', 'title': '', 'value': 'Hello World', 'unit': ''}, 'icons': []})
